<template>
  <Layout>
    <main>
      <section>
        <h1>Start Earning More</h1>
        <p>
          Tribe helps you land great tech + creative roles at companies looking
          to hire top talent.
        </p>
        <div>
          <g-image
      ...
      <section>
        ...
        <p>
          When you become a member with Tribe, you’ll be able to apply to some
          of the best jobs in the Tech + Creative industries
        </p>
      ...
      <section>
        <h2>Join Tribe</h2>
        <p>
          Email Tribe, and together we can help you find jobs in Tech + Creative
        ...
        >
          ...
          <div>
            ...
            <input
              ...
              maxlength="256"
              name="join-phone"
              data-name="Join Phone"
              placeholder="904-867-5309"
              id="join-phone"
              required=""
            />
          </div>
          ...
          <div>
            <label for="join-location">Location</label>
            <input
              type="text"
              maxlength="256"
              name="join-location"
              data-name="Join Location"
          ...
          <div>
            <label for="join-roles">Desired Roles</label>
            <input
              type="text"
              maxlength="256"
              name="join-roles"
              data-name="Join Roles"
          ...
          <div>
            <label for="join-skills">Skills and Tools You Use</label>
            <input
              type="text"
              maxlength="256"
              name="join-skills"
          ...
          <input
            type="submit"
            value="Join Tribe"
            data-wait="Someone will be with you shortly!"
